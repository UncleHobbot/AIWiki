---
name: "source-command-wiki-check"
description: "Migrated source command `wiki-check`"
---

# source-command-wiki-check

Use this skill when the user asks to run the migrated source command `wiki-check`.
...
4. For files where the divider is missing:
   ...
   b. Generate a natural Russian translation following the language rules in AGENTS.md:

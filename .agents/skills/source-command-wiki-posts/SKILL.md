---
name: "source-command-wiki-posts"
description: "Migrated source command `wiki-posts`"
---

# source-command-wiki-posts

Use this skill when the user asks to run the migrated source command `wiki-posts`.

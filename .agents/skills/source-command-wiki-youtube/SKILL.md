---
name: "source-command-wiki-youtube"
description: "Migrated source command `wiki-youtube`"
---

# source-command-wiki-youtube

Use this skill when the user asks to run the migrated source command `wiki-youtube`.

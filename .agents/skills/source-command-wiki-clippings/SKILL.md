---
name: "source-command-wiki-clippings"
description: "Migrated source command `wiki-clippings`"
---

# source-command-wiki-clippings

Use this skill when the user asks to run the migrated source command `wiki-clippings`.
...
Language rules: see AGENTS.md § Language Rules for Russian Translation.

---
name: "source-command-wiki-index"
description: "Migrated source command `wiki-index`"
---

# source-command-wiki-index

Use this skill when the user asks to run the migrated source command `wiki-index`.

---
name: "source-command-wiki-pipeline"
description: "Migrated source command `wiki-pipeline`"
---

# source-command-wiki-pipeline

Use this skill when the user asks to run the migrated source command `wiki-pipeline`.

## Command Template

Run the full wiki maintenance pipeline in canonical order.

Loads and executes the wiki-pipeline skill at .Codex/skills/wiki-pipeline/SKILL.md.
...
See .Codex/skills/wiki-pipeline/SKILL.md for full input specifications,

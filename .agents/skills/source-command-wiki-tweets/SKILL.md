---
name: "source-command-wiki-tweets"
description: "Migrated source command `wiki-tweets`"
---

# source-command-wiki-tweets

Use this skill when the user asks to run the migrated source command `wiki-tweets`.
